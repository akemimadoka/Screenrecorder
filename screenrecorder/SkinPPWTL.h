...
typedef struct _ResourceInfo
{
	...
	_ResourceInfo()
	{
		...
		ZeroMemory(szResImageName, sizeof(szResImageName));
		bHorzSplit = TRUE;
		nLength = -1;
		nCount = -1;
		nIndex = -1;
...
SKINPPWTL_API BOOL skinppLoadSkinFromRes(HINSTANCE hInstance, LPCSTR szResourceName,
										LPCSTR szResourceType, CHAR* szSkinFileName);
